    ...
    <SafeAreaView style={globalStyles.safe}>
      <View style={styles.row}>
        ...
        <Image
          style={styles.image}
          source={{
            uri: "https://cdn.ome.lt/Z8uv4h9Sl9w4b4xJJDFySIDGBXA=/fit-in/1070x750/smart/filer_public/d7/2b/d72bb848-8dc5-49a2-98cc-580dea871592/avengers-infinity-war-poster.jpeg",
          }}
        />
        <Image
          style={styles.image}
          source={{
            uri: "https://blog.uceff.edu.br/wp-content/uploads/2019/02/poster-cartaz-breaking-bad-serie-netflix-sucesso.jpg",
          }}
        />
      </View>
      ...
      <TouchableOpacity onPress={navigateToProducts}>
        <Text style={{ color: "#4A90E2", alignSelf: "center", marginTop: 20 }}>
